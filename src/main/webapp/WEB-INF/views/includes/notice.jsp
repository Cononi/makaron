...
<meta charset="UTF-8">
<link
	href="${pageContext.request.contextPath}/resources/styles/notice.css"
	rel="stylesheet">
				...
				<div class="card">
					...
					<div id="collapse1" class="collapse" aria-labelledby="heading1"
						...
						<div class="card-body">
							...
							▶ MY페이지 ▶ 포인트) <br> <br> - 단, 부분 취소/환불의 경우 실 결제하신 상품가
							전액 환급되며, 포인트는 환급되지 않습니다. <br> <br> [쿠폰] <br> <br>
					...
					<div class="card-header" id="heading3">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed" type="button"
								...
								aria-expanded="false" aria-controls="collapse3">▼ 환불은
								언제 되나요?</button>
						</h5>
					</div>
					...
					<div class="card-header" id="heading4">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed" type="button"
								...
								aria-expanded="false" aria-controls="collapse4">▼ 반품비는
								환불금액에서 차감이 가능한가요?</button>
						</h5>
					</div>
				...
				<div class="card">
					<div class="card-header" id="heading5">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed" type="button"
								...
								aria-expanded="false" aria-controls="collapse5">▼ 교환/반품
								시 택배비가 발생되나요?</button>
						</h5>
					</div>
					<div id="collapse5" class="collapse" aria-labelledby="heading5"
						...
						<div class="card-body">
							...
							<br> <br> ※ 스토어마다 교환/반품 방법 및 금액이 상이하며 &nbsp; 배송비 차감
							시스템이 제공되지 않습니다. <br> <br> 따라서 환불요청 접수 시 [배송비 0원] 으로
							표기되며, 구매하신 스토어 측으로 반품비 관련 별도 문의 바랍니다.
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header" id="heading6">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed" type="button"
								...
								aria-expanded="false" aria-controls="collapse6">▼ 환불/교환
								신청은 어떻게 하나요?</button>
						</h5>
					</div>
					<div id="collapse6" class="collapse" aria-labelledby="heading6"
						...
						<div class="card-body">
							...
							<br> <br> 각 스토어마다 환불 및 교환의 규정에 차이가 있을 수 있어 구매한 스토어
							고객센터로 직접 관련 문의 바랍니다. <br> <br> <br> <br> 스토어
							고객센터와 연결이 어려울 경우 <br> <br> 주문/배송조회 ▶ 상품사진클릭 ▶ 상세페이지 ▶
							Q&amp;A 게시글 작성을 해주시면 영업일 기준 24시간 이내 판매자 답변을 받아 보실 수 있습니다.<br>
							<br>영업일 기준 24시간 내 미답변 시, Makaron 고객센터 또는 카카오톡채널 [@Makaron]로
							문의 바랍니다.
						</div>
					</div>
				</div>
					...
					<div class="card-header" id="heading7">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed" type="button"
								...
								aria-expanded="false" aria-controls="collapse7">▼ 주문을
								취소하고 싶어요!</button>
						</h5>
					</div>
				...
				<div class="card">
					...
					<div id="collapse8" class="collapse" aria-labelledby="heading8"
						...
						<div class="card-body">
							...
							있으며,<br> <br>자세한 비용은 상품 상세 페이지 ▶ 주문정보 또는 스토어 개별안내를 통해
							확인 바랍니다.<br> <br>확인이 어려울 경우 구매하신 스토어 고객센터 및 상품 상세 페이지 ▶
							Q&amp;A &nbsp;문의 바랍니다.
						</div>
					</div>
					<div class="card">
						...
						<div id="collapse9" class="collapse" aria-labelledby="heading9"
							data-parent="#accordionExample">
							<div class="card-body">
								스토어에서 미처 취소한 내역을 확인하지 못하고 출고되는 경우가 있습니다.<br> <br>이미
								취소한 상품이므로 상품을 수령하셨다면&nbsp;스토어 고객센터 또는 상품 상세 페이지 ▶ Q&amp;A로 문의
								바랍니다.
							</div>
						</div>
					</div>
						...
						<div class="card-header" id="heading10">
							<h5 class="mb-0">
								<button class="btn btn-link collapsed" type="button"
									...
									aria-expanded="false" aria-controls="collapse10">▼ 상품
									못받았는데, 배송완료 처리되었어요!</button>
							</h5>
						</div>
						<div id="collapse10" class="collapse" aria-labelledby="heading10"
							data-parent="#accordionExample">
							<div class="card-body">
								먼저, 불편을 드려 죄송합니다.<br> <br>구입한 상품의 실제 배송과 택배 시스템의 차이가
								있을 수 있는 점 양해바랍니다.<br> <br> <br> <br>- 배송 조회
								시 이동중일 경우 1-3일내로 수령 가능합니다.<br> <br>- 배송 완료 장소를 확인하였으나
						...
						<div class="card-header" id="heading11">
							<h5 class="mb-0">
								<button class="btn btn-link collapsed" type="button"
									...
									aria-expanded="false" aria-controls="collapse11">▼ 주문한
									상품과 다른 상품 또는 불량입니다!</button>
							</h5>
						</div>
						...
						<div class="card-header" id="heading12">
							<h5 class="mb-0">
								<button class="btn btn-link collapsed" type="button"
									...
									aria-expanded="false" aria-controls="collapse12">▼ 주문
									취소한 가상계좌에 입금을 했어요!</button>
							</h5>
						</div>
						...
						<div class="card-header" id="heading14">
							<h5 class="mb-0">
								<button class="btn btn-link collapsed" type="button"
									...
									aria-expanded="false" aria-controls="collapse14">▼ 주문
									후 결제 수단을 변경할 수 있나요?</button>
							</h5>
						</div>
					...
					<div class="card">
						<div class="card-header" id="heading16">
							<h5 class="mb-0">
								<button class="btn btn-link collapsed" type="button"
									...
									aria-expanded="false" aria-controls="collapse16">▼ 상품에
									대해 문의하고 싶어요!</button>
							</h5>
						</div>
						<div id="collapse16" class="collapse" aria-labelledby="heading16"
							...
							<div class="card-body">
								...
								:<br> <br>브랜디 APP/WEB ▶ MY페이지 ▶ 주문/배송조회 클릭 ▶ 상품의 이미지
								클릭 ▶ &nbsp;상세페이지 접속▶ Q&amp;A 문의글 작성<br> <br>단, 비회원의 경우
								Q&amp;A 작성이 불가하니 참고바랍니다.
							</div>
						</div>
					</div>
