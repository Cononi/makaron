...
<%-- 						href="${pageContext.request.contextPath}/list">인기순</a></li> --%>
<!-- 					<li class="nav-item"><a class="nav-link" -->
<%-- 						href="${pageContext.request.contextPath}/list">가격낮은순</a></li> --%>
<!-- 					<li class="nav-item"><a class="nav-link" href="#">가격높은순</a></li> -->
<!-- 				</ul> -->
<!-- 			</div> -->
<!-- 		</div> -->
			...
			<ul class="pageMaker">
				...
				<c:if test="${PageMakerDTO.prev}">
					<li class="pageMaker_btn prev"><a
						href="${PageMakerDTO.pageStart -1}">이전</a></li>
				</c:if>

				<!--  페이지번호 -->
				<c:forEach begin="${PageMakerDTO.pageStart}"
					end="${PageMakerDTO.pageEnd}" var="num">
					<li
						class="pageMaker_btn ${PageMakerDTO.cri.pageNum == num ? 'active':''}">
						<a href="${num}">${num}</a>
					</li>
				</c:forEach>
				...
				<c:if test="${PageMakerDTO.next}">
					<li class="pageMaker_btn next"><a
						href="${PageMakerDTO.pageEnd + 1}">다음</a></li>
				</c:if>
			</ul>
		</div>
	</div>
